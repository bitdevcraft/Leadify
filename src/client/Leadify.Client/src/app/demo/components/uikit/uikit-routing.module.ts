  ...
  imports: [
    RouterModule.forChild([
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./floatlabel/floatlabeldemo.module').then((m) => m.FloatlabelDemoModule),
      },
      {
        path: 'formlayout',
        data: {breadcrumb: 'Form Layout'},
        loadChildren: () =>
          import('./formlayout/formlayoutdemo.module').then((m) => m.FormLayoutDemoModule),
      },
      {
        path: 'input',
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./invalid/invalidstatedemo.module').then((m) => m.InvalidStateDemoModule),
      },
      {
        path: 'list',
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./messages/messagesdemo.module').then((m) => m.MessagesDemoModule),
      },
      {
        path: 'misc',
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./overlays/overlaysdemo.module').then((m) => m.OverlaysDemoModule),
      },
      {
        path: 'panel',
